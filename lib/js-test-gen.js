...
export default {
  ...
  generateTestTemplate() {
    ...
    if ((editor = atom.workspace.getActiveTextEditor())) {
      ...
      // file info: Name, path
      const srcFileName = editor.getTitle().replace(/\.(js|ts|jsx|tsx)$/, ""); //file name without extension
      const filePath = removeRest(editor.getPath(), "/"); // The dir the file is located
